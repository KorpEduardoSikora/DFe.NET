...
namespace CTe.Wsdl.Inutilizacao
{
    public class CteInutilizacao
    {
        ...
        public async Task<XmlNode> cteInutilizacaoCT(XmlNode cteDadosMsg)
        {
            soapEnvelope.body = new ResponseBody<XmlNode>
            {
                cteDadosMsg = cteDadosMsg
            };
            return await RequestBuilderAndSender.Execute(soapEnvelope, configuracao, Enums.TipoEvento.CTeInutilizacao, "retInutCTe");
        }
    }
