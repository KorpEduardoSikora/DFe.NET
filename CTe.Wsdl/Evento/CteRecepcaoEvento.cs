...
namespace CTe.Wsdl.Evento
{
    public class CteRecepcaoEvento
    {
        ...
        public async Task<XmlNode> cteRecepcaoEvento(XmlNode cteDadosMsg)
        {
            soapEnvelope.body = new ResponseBody<XmlNode>
            {
                cteDadosMsg = cteDadosMsg
            };
            return await RequestBuilderAndSender.Execute(soapEnvelope, configuracao, Enums.TipoEvento.CTeDistribuicaoDFe, "retEventoCTe");
        }
    }
