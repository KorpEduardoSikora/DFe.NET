...
namespace CTe.Wsdl.ConsultaProtocolo
{
    ...
    public class CteConsulta
    {
        ...
        public async Task<XmlNode> cteConsultaCT(XmlNode cteDadosMsg)
        {
            soapEnvelope.body = new ResponseBody<XmlNode>
            {
                cteDadosMsg = cteDadosMsg
            };
            return await RequestBuilderAndSender.Execute(soapEnvelope, configuracao, Enums.TipoEvento.CTeConsulta, "retConsSitCTe");
        }
    }
