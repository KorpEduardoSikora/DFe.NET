...
namespace CTe.Wsdl.RetRecepcao
{
    public class CteRetRecepcao
    {
        ...
        public async Task<XmlNode> cteRetRecepcao(XmlNode cteDadosMsg)
        {
            soapEnvelope.body = new ResponseBody<XmlNode>
            {
                cteDadosMsg = cteDadosMsg
            };
            return await RequestBuilderAndSender.Execute(soapEnvelope, configuracao, Enums.TipoEvento.CTeRetRecepcao, "retConsReciCTe");
        }
    }
