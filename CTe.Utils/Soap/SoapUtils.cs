...
namespace CTe.Utils.Soap
{
    ...
    public class SoapUtils
    {
        ...
        /// <returns></returns>
        public async Task<string> SendRequest(XmlDocument xmlEnvelop, X509Certificate2 certificadoDigital, string url, int timeOut, Enums.Enums.TipoEvento tipoEvento)
        {
